...
import {HoverOverlayPanel} from '../../../../../../src/components/controls/HoverOverlayPanel'
...
- 添加了新方法 <HoverOverlayPanel content={<GetTopmostBlock/>} trigger={<code>getTopmostBlock</code>}/> ，此方法将从世界顶部向下执行射线检测，尝试寻找首个固体方块
<HiddenSourceText>
